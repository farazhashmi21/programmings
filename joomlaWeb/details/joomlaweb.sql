...
DROP TABLE IF EXISTS `ihx98_action_log_config`;
...
DROP TABLE IF EXISTS `ihx98_action_logs`;
...
(3, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN',  '{\"action\":\"login\",\"userid\":\"47\",\"username\":\"adminFarazHashmi\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=47\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}',  '2021-02-19 17:10:08',  'com_users',  47, 0,  'COM_ACTIONLOGS_DISABLED'),
(4, 'PLG_ACTIONLOG_JOOMLA_USER_CACHE',  '{\"action\":\"cache\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_USER\",\"id\":\"47\",\"title\":\"adminFarazHashmi\",\"itemlink\":\"index.php?option=com_users&task=user.edit&id=47\",\"userid\":\"47\",\"username\":\"adminFarazHashmi\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=47\",\"group\":\"all\"}', '2021-02-19 17:19:22',  'com_cache',  47, 47, 'COM_ACTIONLOGS_DISABLED'),
(5, 'PLG_ACTIONLOG_JOOMLA_USER_CACHE',  '{\"action\":\"cache\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_USER\",\"id\":\"47\",\"title\":\"adminFarazHashmi\",\"itemlink\":\"index.php?option=com_users&task=user.edit&id=47\",\"userid\":\"47\",\"username\":\"adminFarazHashmi\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=47\",\"group\":\"all\"}', '2021-02-19 17:19:29',  'com_cache',  47, 47, 'COM_ACTIONLOGS_DISABLED'),
(6, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_OUT', '{\"action\":\"logout\",\"id\":\"47\",\"userid\":\"47\",\"username\":\"adminFarazHashmi\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=47\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2021-02-19 17:20:09',  'com_users',  47, 47, 'COM_ACTIONLOGS_DISABLED');

DROP TABLE IF EXISTS `ihx98_action_logs_extensions`;
...
DROP TABLE IF EXISTS `ihx98_action_logs_users`;
...
DROP TABLE IF EXISTS `ihx98_assets`;
...
DROP TABLE IF EXISTS `ihx98_associations`;
...
DROP TABLE IF EXISTS `ihx98_banner_clients`;
...
DROP TABLE IF EXISTS `ihx98_banner_tracks`;
...
DROP TABLE IF EXISTS `ihx98_banners`;
...
DROP TABLE IF EXISTS `ihx98_categories`;
...
DROP TABLE IF EXISTS `ihx98_contact_details`;
...
DROP TABLE IF EXISTS `ihx98_content`;
...
DROP TABLE IF EXISTS `ihx98_content_frontpage`;
...
DROP TABLE IF EXISTS `ihx98_content_rating`;
...
DROP TABLE IF EXISTS `ihx98_content_types`;
...
DROP TABLE IF EXISTS `ihx98_contentitem_tag_map`;
...
DROP TABLE IF EXISTS `ihx98_core_log_searches`;
...
DROP TABLE IF EXISTS `ihx98_extensions`;
...
(452, 0,  'plg_system_updatenotification',  'plugin', 'updatenotification', 'system', 0,  1,  1,  0,  '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1613754436}', '', '', 0,  '0000-00-00 00:00:00',  0,  0),
...
(454, 0,  'plg_system_stats', 'plugin', 'stats',  'system', 0,  1,  1,  0,  '{\"name\":\"plg_system_stats\",\"type\":\"plugin\",\"creationDate\":\"November 2013\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_STATS_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"stats\"}', '{\"mode\":1,\"lastrun\":1613754609,\"unique_id\":\"976ad18e5b24a313dc4223690b2e64d200543bb9\",\"interval\":12}', '', '', 0,  '0000-00-00 00:00:00',  0,  0),
...
DROP TABLE IF EXISTS `ihx98_fields`;
...
DROP TABLE IF EXISTS `ihx98_fields_categories`;
...
DROP TABLE IF EXISTS `ihx98_fields_groups`;
...
DROP TABLE IF EXISTS `ihx98_fields_values`;
...
DROP TABLE IF EXISTS `ihx98_finder_filters`;
...
DROP TABLE IF EXISTS `ihx98_finder_links`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_terms0`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_terms1`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_terms2`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_terms3`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_terms4`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_terms5`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_terms6`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_terms7`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_terms8`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_terms9`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_termsa`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_termsb`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_termsc`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_termsd`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_termse`;
...
DROP TABLE IF EXISTS `ihx98_finder_links_termsf`;
...
DROP TABLE IF EXISTS `ihx98_finder_taxonomy`;
...
DROP TABLE IF EXISTS `ihx98_finder_taxonomy_map`;
...
DROP TABLE IF EXISTS `ihx98_finder_terms`;
...
DROP TABLE IF EXISTS `ihx98_finder_terms_common`;
...
DROP TABLE IF EXISTS `ihx98_finder_tokens`;
...
DROP TABLE IF EXISTS `ihx98_finder_tokens_aggregate`;
...
DROP TABLE IF EXISTS `ihx98_finder_types`;
...
DROP TABLE IF EXISTS `ihx98_languages`;
...
DROP TABLE IF EXISTS `ihx98_menu`;
...
DROP TABLE IF EXISTS `ihx98_menu_types`;
...
DROP TABLE IF EXISTS `ihx98_messages`;
...
DROP TABLE IF EXISTS `ihx98_messages_cfg`;
...
DROP TABLE IF EXISTS `ihx98_modules`;
...
DROP TABLE IF EXISTS `ihx98_modules_menu`;
...
DROP TABLE IF EXISTS `ihx98_newsfeeds`;
...
DROP TABLE IF EXISTS `ihx98_overrider`;
...
DROP TABLE IF EXISTS `ihx98_postinstall_messages`;
...
DROP TABLE IF EXISTS `ihx98_privacy_consents`;
...
DROP TABLE IF EXISTS `ihx98_privacy_requests`;
...
DROP TABLE IF EXISTS `ihx98_redirect_links`;
...
DROP TABLE IF EXISTS `ihx98_schemas`;
...
DROP TABLE IF EXISTS `ihx98_session`;
...
(UNHEX('316B7435716E6F38723474676A74736D396C66716C687332326E'), 1,  1,  1613755209, 'joomla|s:736:\"\";', 0,  ''),
(UNHEX('6735733839367676626D6E6A34623961736E7038386634676133'), 0,  1,  1613755215, 'joomla|s:788:\"\";', 0,  ''),
(UNHEX('683232353863697436686E6B6A65626F6A7338356D327171666F'), 1,  1,  1599562264, 'joomla|s:736:\"\";', 0,  ''),
(UNHEX('6B66696F706630646A7470363439367062696C34346F6C726167'), 0,  1,  1599562270, 'joomla|s:664:\"\";', 0,  ''),
(UNHEX('6F716D68766F7466357632346F34703738366A64627130676630'), 0,  1,  1599562049, 'joomla|s:664:\"\";', 0,  '');

DROP TABLE IF EXISTS `ihx98_tags`;
...
DROP TABLE IF EXISTS `ihx98_template_styles`;
...
DROP TABLE IF EXISTS `ihx98_ucm_base`;
...
DROP TABLE IF EXISTS `ihx98_ucm_content`;
...
DROP TABLE IF EXISTS `ihx98_ucm_history`;
...
DROP TABLE IF EXISTS `ihx98_update_sites`;
...
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml',  1,  1613754438, ''),
(2, 'Accredited Joomla! Translations',  'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1,  1613754619, ''),
(3, 'Joomla! Update Component Update Site', 'extension',  'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1,  1613754620, '');

DROP TABLE IF EXISTS `ihx98_update_sites_extensions`;
...
DROP TABLE IF EXISTS `ihx98_updates`;
...
(78,  1,  700,  'Joomla', '', 'joomla', 'file', '', 0,  '3.9.24', '', 'https://update.joomla.org/core/sts/extension_sts.xml', '', ''),
...
(81,  2,  0,  'Romanian', '', 'pkg_ro-RO',  'package',  '', 0,  '3.9.22.1', '', 'https://update.joomla.org/language/details3/ro-RO_details.xml',  '', ''),
(82,  2,  0,  'Flemish',  '', 'pkg_nl-BE',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/nl-BE_details.xml',  '', ''),
(83,  2,  0,  'Chinese Traditional',  '', 'pkg_zh-TW',  'package',  '', 0,  '3.8.0.1',  '', 'https://update.joomla.org/language/details3/zh-TW_details.xml',  '', ''),
(84,  2,  0,  'French', '', 'pkg_fr-FR',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/fr-FR_details.xml',  '', ''),
(85,  2,  0,  'Galician', '', 'pkg_gl-ES',  'package',  '', 0,  '3.3.1.2',  '', 'https://update.joomla.org/language/details3/gl-ES_details.xml',  '', ''),
(86,  2,  0,  'Georgian', '', 'pkg_ka-GE',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/ka-GE_details.xml',  '', ''),
(87,  2,  0,  'Greek',  '', 'pkg_el-GR',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/el-GR_details.xml',  '', ''),
(88,  2,  0,  'Japanese', '', 'pkg_ja-JP',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/ja-JP_details.xml',  '', ''),
...
(93,  2,  0,  'Arabic Unitag',  '', 'pkg_ar-AA',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/ar-AA_details.xml',  '', ''),
...
(97,  2,  0,  'Chinese Simplified', '', 'pkg_zh-CN',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/zh-CN_details.xml',  '', ''),
(98,  2,  0,  'Croatian', '', 'pkg_hr-HR',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/hr-HR_details.xml',  '', ''),
(99,  2,  0,  'Czech',  '', 'pkg_cs-CZ',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/cs-CZ_details.xml',  '', ''),
(100, 2,  0,  'Danish', '', 'pkg_da-DK',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/da-DK_details.xml',  '', ''),
(101, 2,  0,  'Dutch',  '', 'pkg_nl-NL',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/nl-NL_details.xml',  '', ''),
...
(104, 2,  0,  'Italian',  '', 'pkg_it-IT',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/it-IT_details.xml',  '', ''),
...
(107, 2,  0,  'Latvian',  '', 'pkg_lv-LV',  'package',  '', 0,  '3.7.3.1',  '', 'https://update.joomla.org/language/details3/lv-LV_details.xml',  '', ''),
...
(110, 2,  0,  'Norwegian Bokmal', '', 'pkg_nb-NO',  'package',  '', 0,  '3.9.24.2', '', 'https://update.joomla.org/language/details3/nb-NO_details.xml',  '', ''),
(111, 2,  0,  'Norwegian Nynorsk',  '', 'pkg_nn-NO',  'package',  '', 0,  '3.4.2.1',  '', 'https://update.joomla.org/language/details3/nn-NO_details.xml',  '', ''),
(112, 2,  0,  'Persian',  '', 'pkg_fa-IR',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/fa-IR_details.xml',  '', ''),
(113, 2,  0,  'Polish', '', 'pkg_pl-PL',  'package',  '', 0,  '3.9.13.1', '', 'https://update.joomla.org/language/details3/pl-PL_details.xml',  '', ''),
...
(116, 2,  0,  'English AU', '', 'pkg_en-AU',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/en-AU_details.xml',  '', ''),
(117, 2,  0,  'Slovak', '', 'pkg_sk-SK',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/sk-SK_details.xml',  '', ''),
(118, 2,  0,  'English US', '', 'pkg_en-US',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/en-US_details.xml',  '', ''),
(119, 2,  0,  'Swedish',  '', 'pkg_sv-SE',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/sv-SE_details.xml',  '', ''),
(120, 2,  0,  'Syriac', '', 'pkg_sy-IQ',  'package',  '', 0,  '3.4.5.1',  '', 'https://update.joomla.org/language/details3/sy-IQ_details.xml',  '', ''),
(121, 2,  0,  'Tamil',  '', 'pkg_ta-IN',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/ta-IN_details.xml',  '', ''),
(122, 2,  0,  'Thai', '', 'pkg_th-TH',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/th-TH_details.xml',  '', ''),
...
(129, 2,  0,  'German DE',  '', 'pkg_de-DE',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/de-DE_details.xml',  '', ''),
(130, 2,  0,  'Portuguese Brazil',  '', 'pkg_pt-BR',  'package',  '', 0,  '3.9.21.1', '', 'https://update.joomla.org/language/details3/pt-BR_details.xml',  '', ''),
(131, 2,  0,  'Serbian Latin',  '', 'pkg_sr-YU',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/sr-YU_details.xml',  '', ''),
...
(134, 2,  0,  'Serbian Cyrillic', '', 'pkg_sr-RS',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/sr-RS_details.xml',  '', ''),
...
(138, 2,  0,  'Swahili',  '', 'pkg_sw-KE',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/sw-KE_details.xml',  '', ''),
(139, 2,  0,  'Montenegrin',  '', 'pkg_srp-ME', 'package',  '', 0,  '3.3.1.2',  '', 'https://update.joomla.org/language/details3/srp-ME_details.xml', '', ''),
(140, 2,  0,  'English CA', '', 'pkg_en-CA',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/en-CA_details.xml',  '', ''),
(141, 2,  0,  'French CA',  '', 'pkg_fr-CA',  'package',  '', 0,  '3.6.5.1',  '', 'https://update.joomla.org/language/details3/fr-CA_details.xml',  '', ''),
(142, 2,  0,  'Welsh',  '', 'pkg_cy-GB',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/cy-GB_details.xml',  '', ''),
...
(148, 2,  0,  'Slovenian',  '', 'pkg_sl-SI',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/sl-SI_details.xml',  '', ''),
(149, 2,  0,  'Spanish CO', '', 'pkg_es-CO',  'package',  '', 0,  '3.9.15.1', '', 'https://update.joomla.org/language/details3/es-CO_details.xml',  '', ''),
(150, 2,  0,  'German CH',  '', 'pkg_de-CH',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/de-CH_details.xml',  '', ''),
(151, 2,  0,  'German AT',  '', 'pkg_de-AT',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/de-AT_details.xml',  '', ''),
(152, 2,  0,  'German LI',  '', 'pkg_de-LI',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/de-LI_details.xml',  '', ''),
(153, 2,  0,  'German LU',  '', 'pkg_de-LU',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/de-LU_details.xml',  '', ''),
(154, 2,  0,  'English NZ', '', 'pkg_en-NZ',  'package',  '', 0,  '3.9.24.1', '', 'https://update.joomla.org/language/details3/en-NZ_details.xml',  '', ''),
(155, 2,  0,  'Kazakh', '', 'pkg_kk-KZ',  'package',  '', 0,  '3.9.23.1', '', 'https://update.joomla.org/language/details3/kk-KZ_details.xml',  '', '');

DROP TABLE IF EXISTS `ihx98_user_keys`;
...
DROP TABLE IF EXISTS `ihx98_user_notes`;
...
DROP TABLE IF EXISTS `ihx98_user_profiles`;
...
DROP TABLE IF EXISTS `ihx98_user_usergroup_map`;
...
DROP TABLE IF EXISTS `ihx98_usergroups`;
...
DROP TABLE IF EXISTS `ihx98_users`;
...
(47,  'Super User', 'adminFarazHashmi', 'developerfarazhashmi@yahoo.com', '$2y$10$Agqb63noGJI.nFqfkO.YaeJLcDqJtFFCA6UT9UpGkzLxDjzE9Kwvy', 0,  1,  '2020-09-08 10:42:41',  '2021-02-19 17:20:09',  '0',  '', '0000-00-00 00:00:00',  0,  '', '', 0);

DROP TABLE IF EXISTS `ihx98_utf8_conversion`;
...
DROP TABLE IF EXISTS `ihx98_viewlevels`;
